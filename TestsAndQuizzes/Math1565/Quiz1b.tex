...
\begin{enumerate}
 ...
 \begin{enumerate}
 \item $\sin^{-1} (-\frac{\sqrt{3}}{2})$ \points{2}
 
 \vspace{2cm}
 
 \item $\cos^{-1} (\frac{1}{2})$ \points{2}
 
 \vspace{2cm}
 
 \item $\tan^{-1}(\tan(\frac{5 \pi}{4}))$\points{2}
 \end{enumerate} 
 ...
 \begin{enumerate}
 \item 
 Show that $\sinh(-x)=-\sinh(x)$ for all $x \in \mathbb{R}$. \points{3}
 
 \vspace{6cm}
 
 \item  What are the domain and range of $\cosh(x)$?\points{1}
 \end{enumerate}
\end{enumerate}
